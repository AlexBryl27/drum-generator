...
class MusicGAN():
    ...
    def _build_discriminator(self):
        ...
        self.discriminator = Model(notes_in, discriminator_output)
    ...
    def _build_generator(self):
        ...
        for i in range(len(self.generator_filters)):
            ...
            if self.use_batch_norm:
                x = BatchNormalization()(x)
            x = LeakyReLU()(x)
        notes_out = Dense(self.n_notes, activation='tanh')(x)
        self.generator = Model(generator_input, notes_out)
